...
export default function StudentDetailBody({
  ...
  const healthItems: { label: string; value: string; wide?: boolean }[] = [
    ...
    { label: "มียาประจำตัว", value: student.regularMedication ? "✓" : checkedFrom(record, ["มียาประจำตัว", "ยาประจำตัว ถ้ามีกด ✓", "ยาประจำตัว กด ✓", "ยาประจำตัว ถ้ามี"]) },
    { label: "ยาประจำตัว", value: student.regularMedication ?? "-", wide: true },
